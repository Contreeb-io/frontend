...
const trustLinksClassName =
  'absolute top-[calc(100%+8px)] right-0 z-40 w-60 rounded-2xl border border-white/20 bg-[#4b4dbc] p-2 shadow-[0_16px_36px_rgba(18,20,75,.25)] max-[760px]:static max-[760px]:mb-2 max-[760px]:w-full max-[760px]:shadow-none';
...
export default function Hero() {
  return (
    <section id="home" aria-labelledby="hero-heading" className="relative isolate min-h-svh overflow-hidden bg-[#5256a8] text-white">
      ...
      <header className="relative z-30 px-[clamp(32px,5.55vw,80px)] pt-12 max-[1024px]:px-8 max-[760px]:px-6 max-[760px]:pt-7">
        <div className="mx-auto flex w-full max-w-[1760px] items-center justify-between gap-8">
          ...
          <details className="group relative hidden max-[760px]:block">
            ...
            <nav
              ...
              className="absolute top-[calc(100%+8px)] right-0 z-40 w-[min(280px,calc(100vw_-_48px))] rounded-2xl border border-white/20 bg-[#4b4dbc] px-4 py-2 shadow-[0_16px_36px_rgba(18,20,75,.25)]"
              onClick={(event) => {
